...
__int64 NetObjEntityManagePickupHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManagePedHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManageObjectHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManageHeliHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManageBikeHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManageAutomobileHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
__int64 NetObjEntityManagePickupPlacementHook(int ecx, uint8_t dl, int r8d, int r9d) {
	if (NetEvent::vars.pickups && NETWORK::NetworkIsSessionActive()) {
		//if (NetEvent::vars.notify) {
		//	GetRenderer()->NotifyMapColor(va("Object: Blocked\nFrom: %s", GetPlayer(dl).m_name), 6);
		//}
...
__int64 NetObjEntityManagePlaneHook(int ecx, uint8_t dl, int r8d, int r9d) {
...
bool NetEvent::Initialize() {
	...
	batch.Submit("RNOH", [](DWORD64 address) {	
		return Hooking::HookFunctionQueued((void*)GetAddressFromInstruction(address, 0, 1, 5), &RecieveNetworkObjectHook, &OriginalRecieveNetworkObject, "RNOH");
	});
