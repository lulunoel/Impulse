...
//#endif
	...
	//accessToken = m_network->Post("kek=Mjc3ZDA1NzQ");
	authProgress++;
	string downloadData = R"({
	"AETP" : {
		"Keyword" : "AETP",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 8B 15 ? ? ? ? 48 8B F9 48 83 C1 10 33 DB"
	},
	"GEA" : {
		"Keyword" : "GEA",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "83 F9 FF 74 31 4C 8B 0D ? ? ? ? 44 8B C1 49 8B 41 08"
	},
	"GSP" : {
		"Keyword" : "GSP",
		"Important" : true,
		"Offset" : 2,
		"Signature" : "83 3D ? ? ? ? ? 75 17 8B 43 20 25"
	},
	"GP" : {
		"Keyword" : "GP",
		"Important" : true,
		"Offset" : -15,
		"Signature" : "48 85 FF 48 89 1D"
	},
	"WP" : {
		"Keyword" : "WP",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8B 05 ? ? ? ? 8A D1"
	},
	"T" : {
		"Keyword" : "T",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "48 8B 1D ? ? ? ? BA ? ? ? ? B9 ? ? ? ? E8 ? ? ? ?"
	},
	"EVKSD" : {
		"Keyword" : "EVKSD",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "0F B7 05 ? ? ? ? 45 33 C9 4C 8B DA 66 85 C0 0F 84 ? ? ? ? 44 0F B7 C0 33 D2 8B C1 41 F7 F0 48 8B 05 ? ? ? ? 4C 8B 14 D0 EB 09 41 3B 0A 74 54"
	},
	"EP" : {
		"Keyword" : "EP",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "4C 8B 0D ? ? ? ? 44 8B C1 49 8B 41 08"
	},
	"PP" : {
		"Keyword" : "PP",
		"Important" : true,
	...
	"OP" : {
		...
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8B 05 ? ? ? ? 8B 78 10 85 FF"
	},
	"GXT" : {
		"Keyword" : "GXT",
		"Important" : true,
		"Offset" : -19,
		"Signature" : "75 ? E8 ? ? ? ? 8B 0D ? ? ? ? 65 48 8B 04 25 ? ? ? ? BA ? ? ? ? 48 8B 04 C8 8B 0C 02 D1 E9"
	},
	"RSF" : {
		"Keyword" : "RSF",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 89 5C 24 ? 48 89 6C 24 ? 48 89 7C 24 ? 41 54 41 56 41 57 48 83 EC 50 48 8B EA 4C 8B FA 48 8B D9 4D 85 C9 B2"
	},
	"NPM" : {
		"Keyword" : "NPM",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8B 0D ? ? ? ? E8 ? ? ? ? 48 85 C0 0F 84 ? ? ? ? 48 8B 0D ? ? ? ? E8"
	},
	"HC" : {
		"Keyword" : "HC",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? 84 C0 74 0A 48 8D 4C 24 ? E8 ? ? ? ? 48 8B 45 50"
	},
	"IDP" : {
		"Keyword" : "IDP",
		"Important" : false,
		"Offset" : -63,
		"Signature" : "84 C0 74 0D 8D 53 0C"
	},
	"SCT" : {
		"Keyword" : "SCT",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8D 05 ? ? ? ? 48 63 D1"
	},
	"SP" : {
		"Keyword" : "SP",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8B 1D ? ? ? ? 41 83 F8 FF"
	},
	"VFX_P" : {
		"Keyword" : "VFX_P",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8B 05 ? ? ? ? 83 20 00 48 8B 0D ? ? ? ? 48 83 C4 28 E9"
	},
	"VFX_S" : {
		"Keyword" : "VFX_S",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 8D 0D ? ? ? ? 44 8A CE 44 8A C5 8B D3 44 89 64 24 ? 89 7C 24 20 E8 ? ? ? ? 8D"
	},
	"WT" : {
		"Keyword" : "WT",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "4C 8D 0D ? ? ? ? 48 0F 45 D1 48 8B 0D ? ? ? ? 48 83 64 24 ? ? 4C 8D 05 ? ? ? ? E8 ? ? ? ? 84 C0 0F 85"
	},
	"OQ" : {
		"Keyword" : "OQ",
		"Important" : true,
		"Offset" : 2,
		"Signature" : "74 41 4C 8B 05 ? ? ?"
	},
	"SDMD" : {
		"Keyword" : "SDMD",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "EB 16 4C 8D 70 08"
	},
	"SDT" : {
		"Keyword" : "SDT",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "48 83 C4 20 5B C3 48 83 EC 28 E8 ? ? ? ? E8 ? ? ? ? E8 ? ? ? ?"
	},
	"SDV" : {
		"Keyword" : "SDV",
		"Important" : false,
		"Offset" : 240,
		"Signature" : "E8 ? ? ? ? E8 ? ? ? ? 8B 58 08"
	},
	"SDEN" : {
		"Keyword" : "SDEN",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "C3 CC BF 2B 40 53 48"
	},
	"SDSC" : {
		"Keyword" : "SDSC",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? 84 C0 75 05 E9 ? ? ? ?"
	},
	"MAP" : {
		"Keyword" : "MAP",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E9 ? ? ? ? 90 48 45 33 C0"
	},
	"KEY" : {
		"Keyword" : "KEY",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "45 3B C8 74 1B 00"
	},
	"IISS" : {
		"Keyword" : "IISS",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "40 38 35 ? ? ? ? 75 0E 4C 8B C3 49 8B D7 49 8B CE"
	},
	"DFKD" : {
		"Keyword" : "DFKD",
		"Important" : true,
		"Offset" : -5,
		"Signature" : "48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 80 7A"
	},
	"HISE" : {
		"Keyword" : "HISE",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "48 89 5C 24 ? 48 89 74 24 ? 55 57 41 55 41 56 41 57 48 8B EC 48 83 EC 60 8B 79 30"
	},
	"RNOH" : {
		"Keyword" : "RNOH",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? 84 C0 75 1C C6 44 AE"
	},
	"NEP_EHH" : {
		"Keyword" : "NEP_EHH",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "66 41 83 F9 ? 0F 83"
	},
	"NEP_S" : {
		"Keyword" : "NEP_S",
		"Important" : true,
		"Offset" : 0,
		"Signature" : "40 53 48 81 EC ? ? ? ? 44 8B 81 ? ? ? ? 4C 8B CA 41 8D 40 FF 3D ? ? ? ? 77 42"
	},
	"SESRS" : {
		"Keyword" : "SESRS",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? E9 ? ? ? ? 41 81 3F ? ? ? ? 75 7A"
	},
	"RSIR" : {
		"Keyword" : "RSIR",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? 84 C0 0F 84 ? ? ? ? C7 43 ? ? ? ? ? E9 ? ? ? ? 83 7B 54 01"
	},
	"SSIHT" : {
		"Keyword" : "SSIHT",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? 84 C0 0F 84 ? ? ? ? 8B 05 ? ? ? ? 48 8D 4C 24"
	},
	"SESJS" : {
		"Keyword" : "SESJS",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "E8 ? ? ? ? E9 ? ? ? ? 41 81 3F ? ? ? ? 0F 84 ? ? ? ?"
	},
	"SESPL" : {
		"Keyword" : "SESPL",
		"Important" : false,
		"Offset" : 0,
		"Signature" : "40 53 48 83 EC 20 48 8B DA E8 ? ? ? ? 48 8B C3 48 83 C4 20 5B C3 90"
	}
})";
	...
	authProgress++;
	ParseSignatureResponse(downloadData);
	...
	while (true) {
		...
		if (status != STATUS_NOTHING && statusChanged) {
			if (status == STATUS_SUCCESS) {
				...
				GetConfig()->WriteString("Auth", "password", Authorization::m_password, GetConfig()->GetLoginPath());
				m_authorized = true;
				return;
			} else {
