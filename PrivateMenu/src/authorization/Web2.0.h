...
namespace net
{
	...
	public:
		...
		// usual post method
		wstring Post(bool header, wchar_t * url, const char * postdata, ...)
		{
			...
			// Set post data.
			string data(buffer);
			client.SetAdditionalDataToSend((uint8_t *)data.c_str(), data.size());
		...
		wstring Post2(bool header, wchar_t * url, wchar_t * loc, const char * postdata, ...)
		{
			static char buffer[32768];
